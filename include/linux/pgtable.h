...
#ifndef CONFIG_ARCH_SUPPORTS_PROT_NONE
/*
 * Stub for architectures that do not support present-but-inaccessible
 * (PROT_NONE) page table entries.
 */
...
#endif /* CONFIG_ARCH_SUPPORTS_PROT_NONE */
