 ...
 * to report why a table was not collapsed.  A file scan that found the PMD folio
 * already in the page cache leaves SCAN_PTE_MAPPED_HUGEPAGE there and still has
 * work: the PTE table is left to retract.
 *
